...
class BreakoutStrategy:
    ...
    def __init__(self, client, db_manager, config_path=None):
        ...
        # Dit zijn de (niet meer gebruikte) procentuele stops:
        #self.trailing_enabled = bool(self.strategy_config.get("trailing_enabled", True))
        #self.trailing_pct = float(self.strategy_config.get("trailing_pct", 2))  # [NOT USED ANYMORE]
        #self.sl_pct = float(self.strategy_config.get("sl_pct", 2))             # [NOT USED ANYMORE]

        # [CHANGED] => max_position_pct / max_position_eur / min_lot
        # net als pullback
    ...
    # def _take_partial_profit(...): # [UITGECOMMENTARIEERD GEEN PARTIALS]
